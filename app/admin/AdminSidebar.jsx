  ...
  return (
    <div>
      <div className="border border-r-2 fixed left-0 top-0 h-screen w-[35vh] p-5">
        <Link href="/admin" className="p-3 hover:bg-muted rounded-md w-full flex font-bold">Main page</Link>
        <ul className="mt-4">
          ...
          <Button className="w-[90%] left-[50%] absolute bottom-5 -translate-x-[50%]" variant="destructive" onClick={handleLogout}>Logout</Button> <br />
          {/* {user ? <>{user.uid}</>:<>n</>} */}
        </ul>
      </div>
    </div>
