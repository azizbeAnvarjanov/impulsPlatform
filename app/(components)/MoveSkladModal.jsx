...
const MoveSkladModal = ({ branchId, roomId, equipment,path }) => {
  ...
  useEffect(() => {
    ...
    const fetchRooms = async () => {
      const roomsCollection = collection(doc(db, "branches", branchId), "storages");
  ...
  const handleMoveEquipment = async () => {
    if (!selectedRoom) {
      return toast.error("Xonani tanlang!");
    }
